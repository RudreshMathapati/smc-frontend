...
const ManageRoutes = () => {
  ...
  const handleTripChange = (e, index) => {
    ...
    setForm((prev) => {
      const trips = deepCopy(prev.trips);
  ...
  // ================= EDIT ALL =================
  const openEditAll = () => {
    const stops = deepCopy(
      form.trips[currentTripIndex]?.stops || []
    );

    setBulkStops(stops);
    setOriginalStopsBackup(deepCopy(stops));
    setEditAllMode(true);
  };
  ...
  const saveBulkChanges = () => {
    ...
    setForm((prev) => ({
      ...prev,
      trips: deepCopy(updatedTrips),
    }));

    setEditAllMode(false);
  };

  const cancelBulkChanges = () => {
    setBulkStops(deepCopy(originalStopsBackup));
    setEditAllMode(false);
  };
      ...
      <div className="p-6 space-y-6">
        ...
        {showForm && (
          <div className="bg-white p-6 rounded shadow space-y-4">
                      ...
                      <tr key={i}>
                        ...
                        <td>
                          <input
                            value={stop.name ?? ""}
                            onChange={(e) =>
                              handleBulkChange(i, "name", e.target.value)
                            }
                          />
                        </td>
                        ...
                        <td>
                          <input
                            value={stop.timingOffset ?? ""}
                            onChange={(e) =>
                              handleBulkChange(i, "timingOffset", e.target.value)
                            }
                          />
                        </td>
                        ...
                        <td>
                          <input
                            value={stop.stage ?? ""}
                            onChange={(e) =>
                              handleBulkChange(i, "stage", e.target.value)
                            }
                          />
                        </td>
                        ...
                        <td>
                          <input
                            value={stop.latitude ?? ""}
                            onChange={(e) =>
                              handleBulkChange(i, "latitude", e.target.value)
                            }
                          />
                        </td>
                        ...
                        <td>
                          <input
                            value={stop.longitude ?? ""}
                            onChange={(e) =>
                              handleBulkChange(i, "longitude", e.target.value)
                            }
                          />
                        </td>
                      </tr>
            ...
            {/* STOPS LIST */}
            <div>
              {safeSort(form.trips[currentTripIndex].stops).map((s, i) => (
                <div key={i}>
          ...
          {loading ? (
            ...
            filteredRoutes.map((r) => (
              <div key={r._id} className="border p-3 mb-2">
                ...
                <div>
                  {safeSort(r.trips[0]?.stops).map((s, i) => (
